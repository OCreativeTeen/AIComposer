...
Supported actions:
    python browser_tasks.py gemini "<prompt>"
    python browser_tasks.py gemini_file "<prompt-file>"
    python browser_tasks.py gemini_clipboard
    python browser_tasks.py status
"""
