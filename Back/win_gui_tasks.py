...
Usage:
    python win_gui_tasks.py click 场景
    python win_gui_tasks.py click 保存
    python win_gui_tasks.py click 审阅发布
    python win_gui_tasks.py select_4step
    python win_gui_tasks.py paste_scene
    python win_gui_tasks.py status
    python win_gui_tasks.py windows
"""
