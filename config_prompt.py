...
现在请根据我提供的图片内容，分析其中呈现的心理主题、情绪状态、人物关系、行为细节、隐含冲突或心理创伤，并生成一段具有真实感的心理咨询式文字。

要求如下：

文章开头必须以“心理咨询来访者”的第一人称口吻开始。
来访者正在向心理咨询师倾诉自己的问题、情绪、困扰或经历。
...
创伤记忆
等等。
中间部分可以加入一个短小但有代入感的故事或生活片段，
用来让这个心理问题更加真实、具体、有画面感。
后半部分切换到“心理咨询师”的视角。
咨询师需要：
揭示这个问题真正的心理根源
分析来访者为何会形成这样的模式
...
300～800字左右。
如果图片中的信息有限，
请结合人物表情、环境、动作、构图、色彩氛围，自行合理推断其心理状态与背后的故事。
输出时不要分点，
直接生成完整自然的一段心理叙事文字。
最终效果应该让读者感觉：
“这说的就是我。”
