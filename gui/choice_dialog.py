...
def _askchoice_media_preview_mp4_video(
    ...
    return ask_mp4_pick_with_trim_preview(
        title,
        choices,
        folder_path,
        parent,
...
def askchoice_media_preview(
    ...
    *,
    ...
    use_mp4_video_preview: 必须为 True 时提供 build_volume_adjusted_pair(src, volume, start=, end=, speed=) -> (tmp_mp4, tmp_wav)。
